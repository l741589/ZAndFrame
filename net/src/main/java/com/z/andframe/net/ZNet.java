...
public class ZNet {
    ...
    private static MockExecutor mockExecutor;
    ...
    public static void setMockExecutor(MockExecutor mockExecutor) {
        ZNet.mockExecutor = mockExecutor;
    }

    public static MockExecutor getMockExecutor() {
        return mockExecutor;
    }
